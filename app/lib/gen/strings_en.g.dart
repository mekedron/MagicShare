...
class Translations implements BaseTranslations<AppLocale, Translations> {
  ...
  late final TranslationsAboutMagicShareEn aboutMagicShare = TranslationsAboutMagicShareEn.internal(_root);
...
class TranslationsNetworkInterfacesPageEn {
  ...
  /// en: 'By default, MagicShare uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.'
  String get info =>
      'By default, MagicShare uses all available network interfaces. You can exclude unwanted networks here. You need to restart the server to apply the changes.';
...
class TranslationsReceiveOptionsPageEn {
  ...
  /// en: '(MagicShare folder)'
  String get appDirectory => '(MagicShare folder)';
...
class TranslationsWebSharePageEn {
  ...
  /// en: 'MagicShare uses a self-signed certificate. You need to accept it in your browser.'
  String get encryptionHint => 'MagicShare uses a self-signed certificate. You need to accept it in your browser.';
...
class TranslationsAboutPageEn {
  ...
  /// en: 'About MagicShare'
  String get title => 'About MagicShare';

  List<String> get description => [
    'MagicShare is a free, open-source app that allows you to securely share files and messages with nearby devices over your local network without needing an internet connection.',
...
// Path: aboutMagicShare
class TranslationsAboutMagicShareEn {
  TranslationsAboutMagicShareEn.internal(this._root);
  ...
  /// en: 'MagicShare is a fork of LocalSend.'
  String get forkNotice => 'MagicShare is a fork of LocalSend.';

  /// en: 'Open localsend.org'
  String get openLocalSend => 'Open localsend.org';
...
class TranslationsTrayEn {
  ...
  /// en: 'Quit MagicShare'
  String get close => 'Quit MagicShare';
...
class TranslationsSettingsTabGeneralEn {
  ...
  /// en: 'Show MagicShare in context menu'
  String get showInContextMenu => 'Show MagicShare in context menu';
...
class TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  /// en: 'MagicShare can't find other devices without having the permission to scan the local network. Please grant this permission in the settings.'
  String get description =>
      'MagicShare can\'t find other devices without having the permission to scan the local network. Please grant this permission in the settings.';
...
class TranslationsDialogsSendModeHelpEn {
  ...
  /// en: 'Recipients who do not have MagicShare installed can download the selected files by opening the link in their browser.'
  String get link => 'Recipients who do not have MagicShare installed can download the selected files by opening the link in their browser.';
}
