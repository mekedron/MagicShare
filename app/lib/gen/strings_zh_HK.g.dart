...
class _TranslationsReceiveOptionsPageZhHk extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '（MagicShare 資料夾）';
  @override
...
class _TranslationsWebSharePageZhHk extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'MagicShare 用嘅係自我簽署憑證。麻煩你喺瀏覽器度允許咗佢。';
  @override
...
class _TranslationsAboutPageZhHk extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => '關於 MagicShare';
  @override
  List<String> get description => [
    'MagicShare 係一款免費嘅開源應用程式，佢可以透過區域網路幫你安全噉將檔案同訊息分享畀附近嘅裝置，全程無需互聯網連線。',
...
class _TranslationsDonationPageZhHk extends TranslationsDonationPageEn {
  ...
  @override
  String get info => 'MagicShare 唔單只免費、開源，仲係冇廣告添㗎！如果你鍾意呢個 app，不妨捐款贊助我哋開發.';
  @override
...
class _TranslationsNetworkInterfacesPageZhHk extends TranslationsNetworkInterfacesPageEn {
  ...
  // Translations
  @override
  String get info => 'MagicShare 預設使用所有可用的網路介面。您可以在這裡排除不需要的網路。您需要重新啟動伺服器才能套用變更。';
  @override
...
class _TranslationsSettingsTabGeneralZhHk extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => '喺檔案功能表嘅「傳送到」項目顯示 MagicShare';
  @override
...
class _TranslationsSettingsTabOtherZhHk extends TranslationsSettingsTabOtherEn {
  ...
  String get title => '其他';
  @override
  String get support => '支援 MagicShare';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedZhHk extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => '喺冇權掃描區域網路嘅情況下 MagicShare 唔會偵測到其他裝置。麻煩你喺系統設定開返呢個權限。';
  @override
...
class _TranslationsDialogsSendModeHelpZhHk extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => '冇裝 MagicShare 嘅裝置可以透過條 link 嚟 download 返揀選嘅項目。';
}
