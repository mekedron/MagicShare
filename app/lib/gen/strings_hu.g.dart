...
class _TranslationsReceiveOptionsPageHu extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(MagicShare mappa)';
  @override
...
class _TranslationsWebSharePageHu extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'A MagicShare a saját aláírt tanúsítványt használja. A böngészőben kell elfogadnod.';
  @override
...
class _TranslationsAboutPageHu extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'A MagicShare';
  @override
  List<String> get description => [
    'A MagicShare egy ingyenes, nyílt forráskódú alkalmazás, amely lehetővé teszi a fájlok és üzenetek biztonságos megosztását a közeli eszközökkel a helyi hálózaton keresztül, internet kapcsolat nélkül.',
...
class _TranslationsDonationPageHu extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'A MagicShare ingyenes, nyílt forráskódú és hirdetések nélküli. Ha megtetszett az alkalmazás, adományával támogathatja a fejlesztést.';
  @override
...
class _TranslationsNetworkInterfacesPageHu extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Alapértelmezésként a MagicShare az összes rendelkezésre álló hálózati interfészt használja. Itt kizárhatja a nem kívánt hálózatokat. A módosítások alkalmazásához újra kell indítania a kiszolgálót.';
  @override
  String get preview => 'Előnézet';
  @override
...
class _TranslationsSettingsTabGeneralHu extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'A MagicShare megjelenítése a helyi menüben';
  @override
...
class _TranslationsSettingsTabOtherHu extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'MagicShare támogatás';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedHu extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'A MagicShare nem találhat más eszközöket a helyi hálózat vizsgálatára vonatkozó engedély nélkül. Adja meg ezt az engedélyt a beállításokban.';
  @override
...
class _TranslationsDialogsSendModeHelpHu extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Azok a címzettek, akiknél nincs telepítve a MagicShare, letölthetik a kiválasztott fájlokat a hivatkozás megnyitásával a böngészőjükben.';
}
