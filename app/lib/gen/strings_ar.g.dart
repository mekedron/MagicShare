...
class _TranslationsReceiveOptionsPageAr extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(مجلد MagicShare)';
  @override
...
class _TranslationsWebSharePageAr extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'يستخدم تطبيق MagicShare شهادة موقع ذاتية التوقيع. يجب عليك قبولها في المتصفح.';
  @override
...
class _TranslationsAboutPageAr extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'عن MagicShare';
  @override
  List<String> get description => [
    'MagicShare هو تطبيق مجاني مفتوح المصدر يسمح لك بمشاركة الملفات والرسائل بشكل آمن مع الأجهزة القريبة عبر شبكتك المحلية دون الحاجة إلى اتصال بالإنترنت.',
...
class _TranslationsDonationPageAr extends TranslationsDonationPageEn {
  ...
  @override
  String get info => 'MagicShare مجاني ومفتوح المصدر وبدون أي إعلانات. إذا أعجبك التطبيق، يمكنك دعم التطوير بالتبرع.';
  @override
...
class _TranslationsTrayAr extends TranslationsTrayEn {
  ...
  @override
  String get close => 'أنهِ MagicShare';
  @override
...
class _TranslationsNetworkInterfacesPageAr extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'بشكل افتراضي، يستخدم MagicShare جميع واجهات الشبكة المتاحة. يمكنك استبعاد الشبكات غير المرغوب فيها هنا. تحتاج إلى إعادة تشغيل الخادم لتطبيق التغييرات.';
  @override
  String get preview => 'معاينة';
}
...
class _TranslationsSettingsTabGeneralAr extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get showInContextMenu => 'إظهار MagicShare في قائمة السياق';
  @override
...
class _TranslationsSettingsTabOtherAr extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'دعم MagicShare';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedAr extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  @override
  String get description => 'لا يمكن ل MagicShare العثور على الأجهزة الأخرى بدون الإذن بفحص الشبكة المحلية. يُرجى منح هذا الإذن في الإعدادات.';
  @override
...
class _TranslationsDialogsSendModeHelpAr extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link => 'يمكن للمستلمين الذين لا يحتوون على MagicShare تنزيل الملفات المحددة عن طريق فتح الرابط في متصفحهم.';
}
