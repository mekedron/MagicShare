...
import 'package:magicshare_app/model/state/send/web/web_send_file.dart';
import 'package:magicshare_app/model/state/send/web/web_send_session.dart';
import 'package:magicshare_app/model/state/send/web/web_send_state.dart';
