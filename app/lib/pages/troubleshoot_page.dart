...
import 'package:magicshare_app/util/native/cmd_helper.dart';
import 'package:magicshare_app/util/native/macos_channel.dart' as macos_channel;
...
import 'package:magicshare_app/widget/dialogs/not_available_on_platform_dialog.dart';
            ...
            primaryButton: _FixButton(
              ...
              onTapMap: {
                TargetPlatform.windows: _CommandFixAction(
                  ...
                  commands: [
                    'netsh advfirewall firewall add rule name="MagicShare" dir=in action=allow protocol=TCP localport=${settings.port}',
                    'netsh advfirewall firewall add rule name="MagicShare" dir=in action=allow protocol=UDP localport=${settings.port}',
                  ],
                ),
              },
            ),
