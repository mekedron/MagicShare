...
class ParentIsolateStateMapper extends ClassMapperBase<ParentIsolateState> {
  ...
  static IsolateConnector<MulticastEvent, SendToIsolateData<MulticastTask>>? _$multicastDiscovery(ParentIsolateState v) => v.multicastDiscovery;
  static const Field<ParentIsolateState, IsolateConnector<MulticastEvent, SendToIsolateData<MulticastTask>>> _f$multicastDiscovery =
...
extension ParentIsolateStateValueCopy<$R, $Out> on ObjectCopyWith<$R, ParentIsolateState, $Out> {
  ParentIsolateStateCopyWith<$R, ParentIsolateState, $Out> get $asParentIsolateState => $base.as(
...
abstract class ParentIsolateStateCopyWith<$R, $In extends ParentIsolateState, $Out> implements ClassCopyWith<$R, $In, $Out> {
  ...
  $R call({
    ...
    IsolateConnector<MulticastEvent, SendToIsolateData<MulticastTask>>? multicastDiscovery,
...
class _ParentIsolateStateCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, ParentIsolateState, $Out>
  ...
  ListCopyWith<
      ...
      IsolateConnector<IsolateTaskStreamResult<double>, SendToIsolateData<IsolateTask<BaseHttpUploadTask>>>,
      ObjectCopyWith<$R, IsolateConnector<IsolateTaskStreamResult<double>, SendToIsolateData<IsolateTask<BaseHttpUploadTask>>>,
          IsolateConnector<IsolateTaskStreamResult<double>, SendToIsolateData<IsolateTask<BaseHttpUploadTask>>>>> get httpUpload => ListCopyWith(
        $value.httpUpload,
