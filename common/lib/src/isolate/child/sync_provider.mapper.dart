...
class SyncStateMapper extends ClassMapperBase<SyncState> {
  ...
  static int _$multicastPort(SyncState v) => v.multicastPort;
  static const Field<SyncState, int> _f$multicastPort = Field(
    'multicastPort',
    _$multicastPort,
    opt: true,
  );
  ...
  static Set<String> _$ownLocalIps(SyncState v) => v.ownLocalIps;
  static const Field<SyncState, Set<String>> _f$ownLocalIps = Field(
    'ownLocalIps',
    _$ownLocalIps,
    opt: true,
  );
  static String? _$devLoopbackRewriteHost(SyncState v) => v.devLoopbackRewriteHost;
  static const Field<SyncState, String> _f$devLoopbackRewriteHost = Field(
    'devLoopbackRewriteHost',
    _$devLoopbackRewriteHost,
    opt: true,
  );
  static int? _$devLoopbackRewritePort(SyncState v) => v.devLoopbackRewritePort;
  static const Field<SyncState, int> _f$devLoopbackRewritePort = Field(
    'devLoopbackRewritePort',
    _$devLoopbackRewritePort,
    opt: true,
  );
  ...
  final MappableFields<SyncState> fields = const {
    ...
    #alias: _f$alias,
    #port: _f$port,
    #multicastPort: _f$multicastPort,
    ...
    #ownLocalIps: _f$ownLocalIps,
    #devLoopbackRewriteHost: _f$devLoopbackRewriteHost,
    #devLoopbackRewritePort: _f$devLoopbackRewritePort,
  };
  ...
  static SyncState _instantiate(DecodingData data) {
    return SyncState(
      ...
      multicastPort: data.dec(_f$multicastPort),
      ...
      ownLocalIps: data.dec(_f$ownLocalIps),
      devLoopbackRewriteHost: data.dec(_f$devLoopbackRewriteHost),
      devLoopbackRewritePort: data.dec(_f$devLoopbackRewritePort),
    );
  }
...
mixin SyncStateMappable {
  ...
  SyncStateCopyWith<SyncState, SyncState, SyncState> get copyWith => _SyncStateCopyWithImpl<SyncState, SyncState>(
        this as SyncState,
        $identity,
        $identity,
      );
...
extension SyncStateValueCopy<$R, $Out> on ObjectCopyWith<$R, SyncState, $Out> {
  SyncStateCopyWith<$R, SyncState, $Out> get $asSyncState => $base.as((v, t, t2) => _SyncStateCopyWithImpl<$R, $Out>(v, t, t2));
}
...
abstract class SyncStateCopyWith<$R, $In extends SyncState, $Out> implements ClassCopyWith<$R, $In, $Out> {
  ...
  $R call({
    ...
    String? devLoopbackRewriteHost,
    int? devLoopbackRewritePort,
  });
...
class _SyncStateCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, SyncState, $Out> implements SyncStateCopyWith<$R, SyncState, $Out> {
  ...
  $R call({
    ...
    bool? serverRunning,
    bool? download,
    Object? ownLocalIps = $none,
    Object? devLoopbackRewriteHost = $none,
    Object? devLoopbackRewritePort = $none,
  }) =>
      $apply(
        FieldCopyWithData({
          ...
          if (multicastPort != $none) #multicastPort: multicastPort,
          ...
          if (ownLocalIps != $none) #ownLocalIps: ownLocalIps,
          if (devLoopbackRewriteHost != $none) #devLoopbackRewriteHost: devLoopbackRewriteHost,
          if (devLoopbackRewritePort != $none) #devLoopbackRewritePort: devLoopbackRewritePort,
        }),
      );
  @override
  SyncState $make(CopyWithData data) => SyncState(
        ...
        multicastPort: data.get(#multicastPort, or: $value.multicastPort),
        ...
        ownLocalIps: data.get(#ownLocalIps, or: $value.ownLocalIps),
        devLoopbackRewriteHost: data.get(
          #devLoopbackRewriteHost,
          or: $value.devLoopbackRewriteHost,
        ),
        devLoopbackRewritePort: data.get(
          #devLoopbackRewritePort,
          or: $value.devLoopbackRewritePort,
        ),
      );
