...
mixin InfoDtoMappable {
  ...
  InfoDtoCopyWith<InfoDto, InfoDto, InfoDto> get copyWith => _InfoDtoCopyWithImpl<InfoDto, InfoDto>(
        this as InfoDto,
        $identity,
        $identity,
      );
...
extension InfoDtoValueCopy<$R, $Out> on ObjectCopyWith<$R, InfoDto, $Out> {
  InfoDtoCopyWith<$R, InfoDto, $Out> get $asInfoDto => $base.as((v, t, t2) => _InfoDtoCopyWithImpl<$R, $Out>(v, t, t2));
}
...
class _InfoDtoCopyWithImpl<$R, $Out> extends ClassCopyWithBase<$R, InfoDto, $Out> implements InfoDtoCopyWith<$R, InfoDto, $Out> {
  ...
  @override
  InfoDtoCopyWith<$R2, InfoDto, $Out2> $chain<$R2, $Out2>(Then<$Out2, $R2> t) => _InfoDtoCopyWithImpl<$R2, $Out2>($value, $cast, t);
}
