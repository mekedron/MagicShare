...
mixin RegisterDtoMappable {
  ...
  RegisterDtoCopyWith<RegisterDto, RegisterDto, RegisterDto> get copyWith => _RegisterDtoCopyWithImpl<RegisterDto, RegisterDto>(
        this as RegisterDto,
        $identity,
        $identity,
      );
...
extension RegisterDtoValueCopy<$R, $Out> on ObjectCopyWith<$R, RegisterDto, $Out> {
  RegisterDtoCopyWith<$R, RegisterDto, $Out> get $asRegisterDto => $base.as((v, t, t2) => _RegisterDtoCopyWithImpl<$R, $Out>(v, t, t2));
}
